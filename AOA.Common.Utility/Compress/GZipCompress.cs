...
namespace AOA.Common.Utility.Compress
{
    ...
    public static class GZipCompress
    {
        ...
        public static byte[] Compress(byte[] source)
        {
            ...
            {
                GZipOutputStream mStream = new GZipOutputStream(mMemory, 131072);
        ...
        {
            using (GZipInputStream mStream = new GZipInputStream(new MemoryStream(source)))
            {
                using (MemoryStream mMemory = new MemoryStream())
                {
                    Int32 mSize;
        ...
        {
            byte[] byteSource = Convert.FromBase64String(source);
            return DeCompressStringFromArray(byteSource);
        }
        #endregion
